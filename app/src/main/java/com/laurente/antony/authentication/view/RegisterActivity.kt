package com.laurente.antony.authentication.view
...
import com.laurente.antony.authentication.R
import com.laurente.antony.authentication.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity(), View.OnClickListener, View.OnFocusChangeListener, View.OnKeyListener{
    ...
    private fun validatePasswordAndConfirmPassword():Boolean{
        ...
        if(password != confirmpassword){
            errorMessage = "Confirm password doesn't match witch password"
        }
        if(errorMessage !=null){
            mBinding.cPasswordTil.apply {
                isErrorEnabled = true
